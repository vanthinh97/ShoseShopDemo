    ...
    public partial class f1 : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        CreatedByNavigation_Id = c.Int(),
                        ProductImage_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Categories", t => t.CategoryId, cascadeDelete: true)
                .ForeignKey("dbo.TbUsers", t => t.CreatedByNavigation_Id)
                ...
                .Index(t => t.StatusId)
                .Index(t => t.CreatedByNavigation_Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Products", "CreatedByNavigation_Id", "dbo.TbUsers");
            ...
            DropIndex("dbo.Products", new[] { "CreatedByNavigation_Id" });
